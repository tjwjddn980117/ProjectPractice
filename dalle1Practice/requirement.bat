...
call conda install -y anaconda::pillow conda-forge::blobfile anaconda::mypy conda-forge::numpy conda-forge::pytest conda-forge::requests
call pip install attr_utils

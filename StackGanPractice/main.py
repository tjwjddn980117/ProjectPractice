...
if __name__ == "__main__":
    ...
    if cfg.DATA_DIR.find('lsun') != -1:
        from datasets.lsun_data import LSUNClass
        ...
        from datasets.image_data import ImageFolder
        ...
        from datasets.text_data import TextDataset
    ...
    if not cfg.GAN.B_CONDITION:
        from train.uncond_trainer import GANTrainer as trainer
    else:
        from train.cond_trainer import condGANTrainer as trainer
